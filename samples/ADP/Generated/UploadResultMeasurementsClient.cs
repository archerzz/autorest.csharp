...
namespace ADP
{
    ...
    public partial class UploadResultMeasurementsClient
    {
        ...
        public UploadResultMeasurementsClient() : this(new ADPClientOptions())
        {
        }

        /// <summary> Initializes a new instance of UploadResultMeasurementsClient. </summary>
        /// <param name="options"> The options for configuring the client. </param>
        public UploadResultMeasurementsClient(ADPClientOptions options)
        {
        ...
        /// <code><![CDATA[
        /// var client = new UploadResultMeasurementsClient();
        /// 
        /// await foreach (var data in client.ListAsync("<uploadId>"))
        /// {
        ...
        /// var client = new UploadResultMeasurementsClient();
        /// 
        /// foreach (var data in client.List("<uploadId>"))
        /// {
        ///     JsonElement result = JsonDocument.Parse(data.ToStream()).RootElement;
        ///     Console.WriteLine(result.GetProperty("measurementId").ToString());
        /// }
