...
namespace ADP
{
    ...
    public partial class UploadSpecialFilesClient
    {
        ...
        public UploadSpecialFilesClient() : this(new ADPClientOptions())
        {
        }

        /// <summary> Initializes a new instance of UploadSpecialFilesClient. </summary>
        /// <param name="options"> The options for configuring the client. </param>
        public UploadSpecialFilesClient(ADPClientOptions options)
        {
        ...
        /// <code><![CDATA[
        /// var client = new UploadSpecialFilesClient();
        /// 
