...
{
    public partial class DiscoveryUpload : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            writer.WritePropertyName("uploadId");
            writer.WriteStringValue(UploadId);
            writer.WritePropertyName("manifestDownloadUri");
            writer.WriteStringValue(ManifestDownloadUri);
