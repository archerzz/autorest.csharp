...
namespace ADP
{
    ...
    public partial class DiscoverySpecialFilesClient
    {
        ...
        public DiscoverySpecialFilesClient() : this(new ADPClientOptions())
        {
        }

        /// <summary> Initializes a new instance of DiscoverySpecialFilesClient. </summary>
        /// <param name="options"> The options for configuring the client. </param>
        public DiscoverySpecialFilesClient(ADPClientOptions options)
        {
        ...
        /// <code><![CDATA[
        /// var client = new DiscoverySpecialFilesClient();
        /// 
