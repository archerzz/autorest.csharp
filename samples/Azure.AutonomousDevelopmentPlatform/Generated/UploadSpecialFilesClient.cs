...
namespace AutonomousDevelopmentPlatform
{
    ...
    public partial class UploadSpecialFilesClient
    {
        ...
        public UploadSpecialFilesClient(TokenCredential credential) : this(credential, new AutonomousDevelopmentPlatformClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public UploadSpecialFilesClient(TokenCredential credential, AutonomousDevelopmentPlatformClientOptions options)
        {
