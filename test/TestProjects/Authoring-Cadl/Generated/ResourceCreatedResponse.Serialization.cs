...
namespace Foundations
{
    public partial class ResourceCreatedResponse : IUtf8JsonSerializable
    {
        ...
        internal static ResourceCreatedResponse DeserializeResourceCreatedResponse(JsonElement element)
        {
            ...
            return new ResourceCreatedResponse(statusCode, projectName, projectKind, storageInputContainerName, Optional.ToDictionary(settings), Optional.ToNullable(multilingual), description, language, createdDateTime, lastModifiedDateTime, lastTrainedDateTime, lastDeployedDateTime, operationLocation);
        }
