...
namespace Foundations
{
    ...
    public partial class ResourceCreatedResponse
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="projectName"/>, <paramref name="storageInputContainerName"/>, <paramref name="language"/> or <paramref name="operationLocation"/> is null. </exception>
        public ResourceCreatedResponse(int statusCode, string projectName, ProjectKind projectKind, string storageInputContainerName, string language, ResourceLocation operationLocation)
        {
        ...
        /// <param name="operationLocation"></param>
        internal ResourceCreatedResponse(int statusCode, string projectName, ProjectKind projectKind, string storageInputContainerName, IDictionary<string, string> settings, bool? multilingual, string description, string language, DateTimeOffset createdDateTime, DateTimeOffset lastModifiedDateTime, DateTimeOffset lastTrainedDateTime, DateTimeOffset lastDeployedDateTime, ResourceLocation operationLocation)
        {
            StatusCode = statusCode;
            ProjectName = projectName;
            ProjectKind = projectKind;
